			...
			<div class="gtco-container">
				<div class="row row-pb-md">
					<div class="col-md-4 gtco-widget gtco-footer-paragraph">
						...
						<p>Printing and Packaging services</p>
					</div>
					<div class="col-md-4">
						<div class="row">
				...
				<div class="gtco-container">
					<div class="row">
						<div class="col-md-6 text-left">
							<p><small>&copy; 2018 R K Paper Products. All Rights Reserved. </small></p>
						</div>
						<div class="col-md-6 text-right">
							<p><small>Designed by <a href="https://github.com/amitmoondra" target="_blank">Amitmoon</a></small> </p>
						</div>
					</div>
				</div>
			</div>
